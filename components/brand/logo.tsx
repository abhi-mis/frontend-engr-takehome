...
export function Logo({
  ...
  const height = isMark ? width : Math.round(width * ASPECT_FULL);

  return (
    <svg
      width={width}
      height={height}
      viewBox={isMark ? "0 0 107 107" : "0 0 463 107"}
      fill="none"
      className={className}
      {...(decorative
        ? { "aria-hidden": true as const, focusable: false as const }
        : { role: "img" as const, "aria-label": "Propsoch" })}
    >
      <path
        fill="#FF6D33"
